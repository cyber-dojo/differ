...
* [GET diff_lines(was_files,now_files)](docs/api.md#get-diff_lineswas_filesnow_files)
* [GET diff_summary(was_files,now_files)](docs/api.md#get-diff_summarywas_filesnow_files)
