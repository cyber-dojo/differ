...
pushd /tmp
wget https://github.com/kosli-dev/cli/releases/download/v0.1.8/kosli_0.1.8_linux_amd64.tar.gz
tar -xf kosli_0.1.8_linux_amd64.tar.gz
mv kosli /usr/local/bin
popd
