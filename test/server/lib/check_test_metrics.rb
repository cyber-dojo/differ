...
def table_data
  ...
  [
    [ nil ],
    [ 'test.count',    stats['test_count'],    '>=',  73 ],
    ...
    [ nil ],
    [ 'test.lines.total',      test_cov['lines'   ]['total' ], '<=', 525 ],
    ...
    [ nil ],
    [ 'code.lines.total',      code_cov['lines'   ]['total' ], '<=', 352 ],
    [ 'code.lines.missed',     code_cov['lines'   ]['missed'], '<=', 0   ],
    [ 'code.branches.total',   code_cov['branches']['total' ], '<=', 60  ],
    [ 'code.branches.missed',  code_cov['branches']['missed'], '<=', 1   ],
  ]
end
