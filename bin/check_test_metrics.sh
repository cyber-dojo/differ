...
check_coverage()
{
  ...
  exit_non_zero_unless_file_exists "${HOST_TEST_DIR}/lib/test_metrics_limits.rb"  # metric limits
  ...
  docker run \
    ...
    --volume ${HOST_TEST_DIR}/lib/test_metrics_limits.rb:${CONTAINER_TMP_DIR}/test_metrics_limits.rb:ro \
