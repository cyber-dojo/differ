...
check_coverage()
{
  ...
  exit_non_zero_unless_file_exists "${HOST_TEST_DIR}/lib/check_metrics.rb"           # evaluator
  exit_non_zero_unless_file_exists "${HOST_REPORTS_DIR}/coverage_metrics.json"       # data from test run
  exit_non_zero_unless_file_exists "${HOST_TEST_DIR}/lib/coverage_metrics_limits.rb" # metric limits
  ...
  docker run \
    ...
    --rm \
    --entrypoint="" \
    --volume ${HOST_TEST_DIR}/lib/check_metrics.rb:${CONTAINER_TMP_DIR}/check_metrics.rb:ro \
    --volume ${HOST_REPORTS_DIR}/coverage_metrics.json:${CONTAINER_TMP_DIR}/coverage_metrics.json:ro \
    --volume ${HOST_TEST_DIR}/lib/coverage_metrics_limits.rb:${CONTAINER_TMP_DIR}/coverage_metrics_limits.rb:ro \
